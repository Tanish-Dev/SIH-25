    ...
    <div className="space-y-12">
      ...
      <div className="space-y-2">
        <h1 className="text-5xl font-bold text-slate-900 leading-tight tracking-tight">
          Our newest blue‑carbon<br />transformations
        </h1>
        <p className="text-xl text-slate-600 font-medium max-w-2xl">
          Monitoring and verifying blue carbon projects across coastal ecosystems with advanced dMRV technology.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-colors shadow-sm">
          ...
          <div className="h-64 bg-gradient-to-br from-sky-50 to-emerald-50 rounded-xl flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute bottom-12 left-12 w-3 h-3 bg-green-600 rounded-full animate-pulse"></div>
            <div className="text-center">
